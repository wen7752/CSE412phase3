...
$(function(){
	...
	var addPlayList = $(".cplaylistadd");
	var creatPlaylist = $(".cplaylist");	
	var loginLink = $(".loginLink");	
	var signupLink = $(".signupLink");
	var cpinct = $("#cpl-content");
	var cpinctadd = $("#cpladd-content");
	...
	//pop up for create playlist
    addPlayList.on('click', function(event){
    	event.preventDefault();
    	cpinctadd.parents(overlay).addClass("openform");
		$(document).on('click', function(e){
		var target = $(e.target);
		if ($(target).hasClass("overlay")){
				$(target).find(cpinctadd).each( function(){
	...
	//pop up for create playlist
    creatPlaylist.on('click', function(event){
    	event.preventDefault();
    	cpinct.parents(overlay).addClass("openform");
		$(document).on('click', function(e){
		var target = $(e.target);
		if ($(target).hasClass("overlay")){
				$(target).find(cpinct).each( function(){
					$(this).removeClass("openform");
				});
				setTimeout( function(){
					$(target).removeClass("openform");
